...
export default function MaxusSpace() {
    return (<DescriptionContainer>
        ...
        <ProjectLinks links={[
            { href: "https://github.com/Maxuss/maxus.space", desc: "repository", icon: <Nwnp32ServerIcon variant={"16x16_4"} /> },
        ...
        <p>
            ...
            I decided to go for Windows95 style. Despite the fact that I use <Tooltip text={"i use arch btw :3"}>Linux</Tooltip>,
