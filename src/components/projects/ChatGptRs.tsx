...
export default function ChatGptRs() {
    ...
    return (<DescriptionContainer>
        ...
        <ProjectLinks links={[
            ...
            {
                href: "https://crates.io/crates/chatgpt_rs",
                desc: "crates.io",
                icon: <Nwnp32FolderIcon variant={"16x16_4"}/>
            },
            {
                href: "https://docs.rs/chatgpt_rs/latest/chatgpt/",
                desc: "docs.rs",
                icon: <Explorer101 variant={"16x16_4"}/>
            },
        ]}/>
        <p>
            ChatGPT-rs is an asynchronous Rust wrapper for OpenAI ChatGPT. Its features include conversation support,
            message persistence
            and even ChatGPT function definition within rust via procedural macros. At the moment of writing this,
            ChatGPT-rs has just surpassed 6300 total downloads on crates.io
        </p>
        <p>
