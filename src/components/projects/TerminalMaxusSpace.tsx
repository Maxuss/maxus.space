...
export default function TerminalMaxusSpace() {
    return (<DescriptionContainer>
        ...
        <ProjectLinks links={[
            {
                href: "https://github.com/Maxuss/maxus.space-legacy",
                desc: "repository",
        ...
        <p>
            This is my old website that I built in mid 2022. I originally got the idea from <ExternLink
            href={"https://oat.zone/"} desc={"this website"}/> by oatmealine.
            The website is basically a terminal with a theme heavily inspired by the <ExternLink
            href={"https://ohmyz.sh/"} desc={"default oh-my-zsh theme"}/>.
