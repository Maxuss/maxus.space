...
export default function Flare() {
    return (<DescriptionContainer>
        ...
        <ProjectLinks links={[
            ...
            { href: "https://central.sonatype.com/artifact/space.maxus/flare/1.0.0", desc: "maven central", icon: <Cachevu100 variant={"16x16_4"}/> },
            { href: "https://flare.maxus.space", desc: "docs", icon: <Explorer101 variant={"16x16_4"} /> },
            { href: "https://bstats.org/plugin/bukkit/Flare/18411", desc: "bstats", icon: <Shell3214 variant={"16x16_4"} />}
        ]}/>
        <p>
        ...
        <p>
            Flare supports custom components, reactive states, memoization out of the box. It also has a lot of pre-built
            components, ranging from <ExternLink href={"https://flare.maxus.space/ui/composable/#button"} desc={"simple buttons"} />
            ...
            Flare also includes built-in support for <ExternLink href={"https://www.spigotmc.org/resources/placeholderapi.6245/"} desc={"PlaceholderAPI"} />
        </p>
        <p>
            Flare is still not 100% complete. I plan on adding UI definition from <ExternLink href={"https://github.com/lightbend/config/blob/main/HOCON.md"} desc={"HOCON"} />
